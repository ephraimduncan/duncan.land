      ...
      >
            ...
            <AppThemeProvider>
              ...
              <footer className="fixed bottom-0 w-full bg-grey-50 dark:bg-grey-950 z-1000 py-2 border-t border-solid border-grey-100 dark:border-grey-700">
                <div className="mx-auto max-w-[712px] px-4 md:px-0 flex justify-between">
                  ...
                  <div className="text-sm font-nwr">MMXXV</div>
                </div>
              </footer>
        ...
        {process.env.NODE_ENV === "production" && (
          <>
            ...
            {/* Temporarily disabled to isolate error source */}
            {/* <Script
              async
              src="https://0.observe.so/script.js"
              data-app="clx3apzln02eqarwk2byw7gy0"
              onError={(e) => {
                console.warn("Observe script failed to load:", e);
              }}
            /> */}
          </>
        )}
