    ...
    <FadeIn.Container>
      <FadeIn.Item>
        <div className="mb-4 space-y-3">
          ...
          <h2 className="text-base text-foreground-subtle text-balance sm:text-lg">
            Design Engineer
          </h2>
      ...
      <FadeIn.Item>
        <section className="mt-10">
          <h2 className="text-sm text-foreground-subtle text-balance">Projects</h2>
            ...
            {PROJECTS.map((project) => (
              <li key={project.name}>
                ...
                >
                  ...
                  <span className="text-pretty text-sm text-foreground-subtle sm:truncate sm:flex-1">
                    {project.description}
                  </span>
                </a>
              </li>
      ...
      <FadeIn.Item>
        <svg
          ...
          viewBox="0 0 432 38"
          fill="none"
          className="mt-10 mb-2 text-foreground"
        >
          <path
