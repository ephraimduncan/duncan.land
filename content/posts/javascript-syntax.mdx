...
We are done with the `tokenizer`. All the code at this point can be found [here](https://github.com/ephraimduncan/creating-your-own-javascript-syntax/blob/680fd2c769535eb2b0cd1e2bbe8104abddfde392/index.js).
...
There you have it, the `parser` in the flesh. You can use the test case for the `tokenizer` above and pass the tokens to the parser and log the results for yourself. You can get all the code up to this point [here](https://github.com/ephraimduncan/creating-your-own-javascript-syntax/blob/88bdd2b061762aab2ec435e3fba8648591e711da/index.js)
...
That's it for our `traverser`. You can get all the code up to this point [here](https://github.com/ephraimduncan/creating-your-own-javascript-syntax/blob/c8d05eaef93157fdcf9688dac8d5713a372fb8a8/index.js).
...
We are done with the `transformer`, you can get all the code up to this point [here](https://github.com/ephraimduncan/creating-your-own-javascript-syntax/blob/775d3750c94186495ea72796976a5126b48a3ad7/index.js).
...
Finally, we are done with our `generator` and all the three stages. You can get all the code up till this point [here](https://github.com/ephraimduncan/creating-your-own-javascript-syntax/blob/aa3f7e6f55b0ebccfa2a5fbd1f1751535f2555b0/index.js).
